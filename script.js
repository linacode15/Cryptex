...
function unlockCryptex() {
    ...
    if (attempts < maxAttempts) {
        if (userInput === correctCode) {
            ...
            message.textContent = "Para encontrar la respuesta final, descifra este mensaje en código Morse: \"-·--·- -·-· --- - -·-· ·--· ·- /  · - ··· - -· · -·\" Para verificar tu respuesta, suma el número de letras de la primera palabra más el de la segunda, luego multiplica el resultado por 9 y restale 23.";
...
function verifyMorseAnswer() {
    ...
    if (parseInt(morseAnswerInput) === 130) {
        message.style.color = 'green';
